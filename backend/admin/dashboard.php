...
try {
    ...
    // Calculate Multi-Currency Revenue for the Dashboard
    $salesData = $db->getSales();
    $revenueBreakdown = [];
...
$pageTitle = 'Overview - OJG Herbal Admin';
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
    ...
    <div
        ...
        <div class="relative z-10">
            ...
            <div class="mt-8 pt-6 border-t border-white/10 flex flex-wrap gap-8">
                <div>
                ...
                <div>
                    <span class="block text-2xl font-serif">
                        <?php 
                        if (!empty($revenueBreakdown)) {
                            $revParts = [];
                            foreach ($revenueBreakdown as $cur => $sum) {
                    ...
                    <span class="text-xs text-[#A4B4A6] uppercase">Total Revenue</span>
                </div>
            </div>
        </div>
    </div>
