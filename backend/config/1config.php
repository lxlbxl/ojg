...
if (!defined('DB_PATH'))
    define('DB_PATH', APP_ROOT . '/database/ojg_herbal.db');
...
define('APP_NAME', 'OJG Herbal Admin Panel');
...
// Security Settings
define('SESSION_NAME', 'ojg_admin_session');
...
define('ADMIN_EMAIL', 'admin@ojgherbal.com');
